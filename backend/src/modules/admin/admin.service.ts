...
export class AdminService {
  ...
  async setAdminPermissions(
    ...
    const nextPermissions = {
      canManageAdmins:
        dto.canManageAdmins ?? target.adminPermissions.canManageAdmins,
      canModerateContent:
        dto.canModerateContent ?? target.adminPermissions.canModerateContent,
      canEditPlatformPages:
        dto.canEditPlatformPages ??
        target.adminPermissions.canEditPlatformPages,
    };
    const updated = await this.usersRepo.update(userId, {
