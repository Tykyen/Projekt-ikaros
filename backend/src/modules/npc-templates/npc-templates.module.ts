...
import {
  ...
  NpcTemplateSchema,
} from './schemas/npc-template.schema';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      { name: NpcTemplateSchemaClass.name, schema: NpcTemplateSchema },
    ]),
    WorldsModule,
  ],
  ...
  providers: [
    NpcTemplatesService,
    {
      provide: 'INpcTemplatesRepository',
      useClass: MongoNpcTemplatesRepository,
    },
  ],
