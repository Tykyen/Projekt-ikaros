...
import type { CampaignStorylineLevel, CampaignStorylineStatus } from '../interfaces/campaign-storyline.interface';

export class CreateCampaignStorylineDto {
  @IsString() title: string;
  @IsOptional() @IsIn(['macro', 'mid', 'micro']) level?: CampaignStorylineLevel;
  @IsOptional() @IsIn(['active', 'dormant', 'escalating', 'climax', 'closed']) status?: CampaignStorylineStatus;
