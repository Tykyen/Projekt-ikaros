...
export enum SoundPrimaryFunction {
  safe = 'safe',
  social = 'social',
...
export enum SoundEmotionalTone {
  calm = 'calm',
  wonder = 'wonder',
...
export enum SoundOnsetProfile {
  instant = 'instant',
  fast = 'fast',
  soft = 'soft',
  slow = 'slow',
}
export enum SoundOutroProfile {
  hard = 'hard',
  soft = 'soft',
  fade = 'fade',
  seamless = 'seamless',
}
export enum SoundFactionStyle {
  civilian = 'civilian',
  noble = 'noble',
  religious = 'religious',
  military = 'military',
...
export class SoundSchemaClass {
  ...
  @Prop({ type: String, required: false, default: null }) proposedBy:
    | string
    | null;
  @Prop({ type: String, required: false, default: null }) proposedByWorldId:
    | string
    | null;
  @Prop({ type: String, required: false, default: null }) rejectReason:
    | string
    | null;
